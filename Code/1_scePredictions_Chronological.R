...
pacman::p_load(DT, foreach, magrittr, tidyverse,fst, lubridate, # important analytic pkgs
...
setwd("~/sce prediction_REG500_date/Code")
...
#[2] Loading the Data:
# --------------------
df = read_csv("../Data/REG500_SCELag7_date.csv")
df$X1 = NULL
df$driver = NULL
df$distance = NULL
colnames(df) = c('date','intervalTime', 'speedMean', 'speedSD', 'age', 'gender', 'prepInten',
